...
input_path=/scratch/faculty/kjann/Internship/Jolane_2023/real_OCD_ABCD_Complexity/OCD_ABCD_PreprocComplexWOdenoise/
output_path=/scratch/faculty/kjann/testenv/MSE-AUC/run_02/
...
subjects="swusub-NDARINVB8WVUJ5G
