...
do
    ...
    # Submit the job
    echo "Submitting job for subject: $subj"
    qsub -q compute7.q -cwd -N $JOBNAME -o $LOG -e $ERROR -v SUBJ=$subj /scratch/faculty/kjann/testenv/scripts/AUC_calculations/SampEn_HCP_MSE_maps_JKA_gpt_runJOB.sh
done
